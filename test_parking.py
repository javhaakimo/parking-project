...
class ЯгТэнцүүХайлтТест(ФайлТест):
    # Оролт формат шалгагддаг тул хэсэгчилсэн тохиролыг файлд үлдсэн урт (хуучин)
    # дугаар 91111УБА ба зөв оролт 1111УБА-аар шалгана
    ...
    def test_гарах_хэсэгчилсэн_дугаар_олдохгүй(self):
        self._бичих(["91111УБА - 2026-09-23 10:00:00"])
        гаралт = self._ажиллуулах(parking.Машин_гарах, "1111УБА")
        self.assertIn("===== Машин олдсонгүй", гаралт)
        self.assertEqual(self._унших(), "91111УБА - 2026-09-23 10:00:00\n")

    def test_гарах_зөвхөн_яг_таарсныг_гаргана(self):
        self._бичих(["91111УБА - 2026-09-23 10:00:00", "1111УБА - 2026-09-23 11:00:00"])
        гаралт = self._ажиллуулах(parking.Машин_гарах, "1111УБА")
        self.assertEqual(гаралт.count("===== Машин олдлоо"), 1)
        self.assertEqual(self._унших(), "91111УБА - 2026-09-23 10:00:00\n")
